  ...
  days: [
    {
      ...
      date: '27. juli',
      isoDate: '2026-07-27',
      theme: 'Ankomst & indtjekning',
      funFact: 'Barcelona El Prat er Spaniens næststørste lufthavn. Aerobussen kører jer til centrum på ca. 35 minutter.',
      intro:
        'Landing kl. 11:55 med Norwegian D83656. Tag Rodalies R2 Nord-toget fra T2 direkte til Barcelona-Sants (~20 min) — Moxy ligger i gåafstand. Tjek ind, og resten af dagen er fri.',
      highlights: [
      ...
      tips: [
        ...
        'Køb et T-Casual metrokort (10 ture) til transport inde i byen',
