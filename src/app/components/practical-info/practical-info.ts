          ...
          <div class="practical__card">
            <div class="practical__card-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                <path d="M17.8 19.2L16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.4-.1.9.3 1.1l5.5 3.2-2.9 2.9L4.3 13c-.4-.1-.9.1-1 .5l-.1.4c-.1.4 0 .8.3 1l3.1 2.1L8.7 20c.2.3.6.4 1 .3l.4-.1c.4-.2.6-.6.5-1l-1.4-1.9 2.9-2.9 3.2 5.5c.2.4.7.5 1.1.3l.5-.3c.4-.2.6-.6.5-1.1z"/>
              </svg>
            </div>
